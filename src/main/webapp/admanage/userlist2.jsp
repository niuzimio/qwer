...
<script type="text/javascript">
	function updateukey2(id){
		if(confirm("您确定修改么？")){
			window.location="updateukey2?uid="+id;
		}
		return false;
	}
...
<body>
	<form action="queryAll2" name="myform" method="post">
		<!-- 隐藏域  存放当前页号 -->
		...
		<table class="input_table" border="0" cellPadding="3" cellSpacing="0">
			<tr>
				...
				<td class="input_content">&nbsp; <input name="uname"
					value="${param.uname}" />
				</td>
				<td class="input_title">状态</td>
				<td class="input_content"><select name="ukey">
				...
				<td class="input_content"><select name="flag">
						<option value="-1">全部</option>
				...
				<tr>
					...
					<td class="data_cell">
						<button class="op_button" type="button"
							onclick="return updateukey2(${u.uid});">修改状态</button>
					</td>
				</tr>
			</c:forEach>
	...
	<div id="showdiv" style="display: none">
		<table class="input_table" border="0" cellPadding="3" cellSpacing="0">
			<tr>
				<td class="input_title">用户名</td>
				<td class="input_content" id="divname">zhang&nbsp;</td>
